notification = {
    ...
    show: function (message, type, delay) {
        ...
        var bar = $("<div class='notibar " + type + "  alert-dismissable fade show' role='alert'><table width='100%'><tr><td>" + message + "</td><td style='vertical-align:top;text-align:right;'><button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></td></tr></table></div>");
        target.append(bar);
        bar.slideDown("fast");
